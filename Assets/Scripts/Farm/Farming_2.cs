...
public class Farming_2 : MonoBehaviour {

	public static bool changeDay_Farm2 = false;
	private bool dirt;
	...
	void Start () 
	{
        if (Player.ctr_Day_Farm2 >= 1)
        {
            dayCounter = Player.ctr_Day_Farm2;
        }
        else
        {
            dayCounter = 0;
	...
	void Update () 
	{
		...
		if (changeDay_Farm2 && plant_Type == "Tomato") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
				changeDay_Farm2 = false;
			}
		...
		else if (changeDay_Farm2 && plant_Type == "Corn") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
