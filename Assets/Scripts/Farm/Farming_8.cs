...
public class Farming_8 : MonoBehaviour {

	public static bool changeDay_Farm8 = false;
	private bool dirt;
	...
	void Start () 
	{
        if (Player.ctr_Day_Farm8 >= 1)
        {
            dayCounter = Player.ctr_Day_Farm8;
        }
        else
        {
            dayCounter = 0;
	...
	void Update () 
	{
		...
		if (changeDay_Farm8 && plant_Type == "Tomato") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
				changeDay_Farm8 = false;
			}
		...
		else if (changeDay_Farm8 && plant_Type == "Corn") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
