...
public class Farming_9 : MonoBehaviour {

	public static bool changeDay_Farm9 = false;
	private bool dirt;
	...
	void Start () 
	{
        if (Player.ctr_Day_Farm9 >= 1)
        {
            dayCounter = Player.ctr_Day_Farm9;
        }
        else
        {
            dayCounter = 0;
	...
	void Update () 
	{
		...
		if (changeDay_Farm9 && plant_Type == "Tomato") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
				changeDay_Farm9 = false;
			}
		...
		else if (changeDay_Farm9 && plant_Type == "Corn") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
