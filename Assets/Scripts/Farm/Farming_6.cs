...
public class Farming_6 : MonoBehaviour {

	public static bool changeDay_Farm6 = false;
	private bool dirt;
	...
	void Start () 
	{
        if (Player.ctr_Day_Farm6 >= 1)
        {
            dayCounter = Player.ctr_Day_Farm6;
        }
        else
        {
            dayCounter = 0;
	...
	void Update () 
	{
		...
		if (changeDay_Farm6 && plant_Type == "Tomato") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
				changeDay_Farm6 = false;
			}
		...
		else if (changeDay_Farm6 && plant_Type == "Corn") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
