...
public class Farming_7 : MonoBehaviour {

	public static bool changeDay_Farm7 = false;
	private bool dirt;
	...
	void Start () 
	{
        if (Player.ctr_Day_Farm7 >= 1)
        {
            dayCounter = Player.ctr_Day_Farm7;
        }
        else
        {
            dayCounter = 0;
	...
	void Update () 
	{
		...
		if (changeDay_Farm7 && plant_Type == "Tomato") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
				changeDay_Farm7 = false;
			}
		...
		else if (changeDay_Farm7 && plant_Type == "Corn") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
