...
public class Farming : MonoBehaviour {
	...
	public static bool changeDay_Farm1 = false;
	private bool dirt;
	...
	void Start () 
	{
        if (Player.ctr_Day_Farm1 >= 1)
        {
            dayCounter = Player.ctr_Day_Farm1;
        }
        else
        {
            dayCounter = 0;
	...
	void Update () 
	{
        ...
        if (changeDay_Farm1 && plant_Type == "Tomato") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
				changeDay_Farm1 = false;
			}
		...
		else if (changeDay_Farm1 && plant_Type == "Corn") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
