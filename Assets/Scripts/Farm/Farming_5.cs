...
public class Farming_5 : MonoBehaviour {

	public static bool changeDay_Farm5 = false;
	private bool dirt;
	...
	void Start () 
	{
        if (Player.ctr_Day_Farm5 >= 1)
        {
            dayCounter = Player.ctr_Day_Farm5;
        }
        else
        {
            dayCounter = 0;
	...
	void Update () 
	{
		...
		if (changeDay_Farm5 && plant_Type == "Tomato") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
				changeDay_Farm5 = false;
			}
		...
		else if (changeDay_Farm5 && plant_Type == "Corn") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
