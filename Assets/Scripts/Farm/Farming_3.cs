...
public class Farming_3 : MonoBehaviour {

	public static bool changeDay_Farm3 = false;
	private bool dirt;
	...
	void Start () 
	{
        if (Player.ctr_Day_Farm3 >= 1)
        {
            dayCounter = Player.ctr_Day_Farm3;
        }
        else
        {
            dayCounter = 0;
	...
	void Update () 
	{
		...
		if (changeDay_Farm3 && plant_Type == "Tomato") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
				changeDay_Farm3 = false;
			}
		...
		else if (changeDay_Farm3 && plant_Type == "Corn") 
		{
			if (dayCounter == -1) 
			{
				dayCounter = 0;
